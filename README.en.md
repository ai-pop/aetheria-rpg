...
- **Exact generation recovery.** A network break freezes the workflow at the current agent and step; Retry continues after successful tools instead of building a different world over partial state.
