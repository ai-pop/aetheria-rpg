...
Для ошибок используйте [Issues](https://github.com/ai-pop/aetheria-rpg/issues). Для вопросов, идей и впечатлений — [Discussions](https://github.com/ai-pop/aetheria-rpg/discussions).
...
Папка пользовательских данных Windows:
...
Use [Issues](https://github.com/ai-pop/aetheria-rpg/issues) for bugs. Use [Discussions](https://github.com/ai-pop/aetheria-rpg/discussions) for questions, ideas, and playtest feedback.
